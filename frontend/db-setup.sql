...
create table if not exists public.contact_inquiries (
  ...
  constraint contact_inquiries_user_id_fkey foreign key (user_id) references "user" (id) on delete set null
) TABLESPACE pg_default;
...
create table if not exists public.inquiry_replies (
  ...
  constraint inquiry_replies_inquiry_id_fkey foreign key (inquiry_id) references contact_inquiries (id) on delete cascade
) TABLESPACE pg_default;
